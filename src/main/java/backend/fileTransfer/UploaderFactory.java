...
public class UploaderFactory {
    public static Uploader getUploader(Protocols protocol, String serverURL, int port, String username, String password, String workingDir) throws UploaderException {
        switch (protocol) {
            case FTPS:
